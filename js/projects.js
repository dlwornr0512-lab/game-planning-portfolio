...
const PROJECTS = [
  {
    ...
    color: "crimson",
    cardSummary:
      "중세와 동양 무사 테마가 결합된 세계를 배경으로, 주인공이 6가지 무기를 활용해 7개의 죄악을 상징하는 적들을 물리치는 액션 로그라이크 프로젝트입니다.",
    detailSummary:
      "The Last Dance는 중세와 동양 무사 테마가 결합된 세계를 배경으로, 주인공이 죽음과 부활을 반복하며 7개의 죄악을 상징하는 적들을 물리치는 액션 로그라이크 프로젝트입니다. 플레이어는 6가지 무기를 상황에 따라 선택하고 조합하며, 매번 달라지는 전투 흐름 속에서 성장과 선택을 반복합니다. 죽음은 단순한 실패가 아니라 다음 도전을 위한 경험으로 이어지며, 반복 플레이를 통해 전투 숙련도와 빌드 완성도를 높여 나가는 것을 핵심 경험으로 합니다.",
    role:
  ...
  },
  {
    ...
    color: "bronze",
    cardSummary:
      "스팀펑크 스타일의 공중 세계를 배경으로, 인간처럼 생긴 기계로봇 주인공이 기억과 성장 시스템을 통해 세계의 진실에 접근하는 오픈월드 액션 RPG 프로젝트입니다.",
    detailSummary:
      "레오나르의 날개는 스팀펑크 스타일의 공중 세계를 배경으로 한 오픈월드 액션 RPG 프로젝트입니다. 플레이어는 인간처럼 생긴 기계로봇 주인공을 조작해 전투와 탐험을 반복하며 잃어버린 기억을 되찾고, 기억과 성장 시스템을 통해 공중 세계에 숨겨진 진실에 접근하게 됩니다.",
    role:
  ...
  },
  {
    ...
    color: "pastel",
    cardSummary:
      "인간 마법사로 시작한 플레이어가 다양한 종족이 살아가는 판타지 세계를 탐험하며 성장하는 의뢰 기반 전투모험 MMORPG 프로젝트입니다.",
    detailSummary:
      "아르모니아는 인간 마법사로 시작한 플레이어가 다양한 종족이 살아가는 판타지 세계를 탐험하며 성장하는 의뢰 기반 전투모험 MMORPG입니다. 요정족, 거인족, 정령족, 용족, 마족 등 여러 종족과의 만남을 통해 세계관을 확장하고, 수호자, 격투가, 조각가, 소환사, 치유술사 등 개성 있는 직업 클래스를 중심으로 전투와 모험을 경험합니다.",
    role:
